...
function(i) {
    ...
    $(function() {
        ...
        if ($('#success-msg').length > 0) {
            i.NotificationApp.send("", $('#success-msg').html(), "top-left", "#5ba035", "success", 7e3, 1, "plain");
        }
        // info toaster
        if ($('#info-msg').length > 0) {
            i.NotificationApp.send("", $('#info-msg').html(), "top-left", "#1ea69a", "info", 12e3, 1, "plain");
        }
        // failed toaster
        if ($('#failed-msg').length > 0) {
            i.NotificationApp.send("", $('#failed-msg').html(), "top-left", "#bf441d", "error", 12e3, 1, "plain");
        }
    });
