                            ...
                            <div class='form-group mb-3'>
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-6 text-right">
                                        ...
                                        <x-selectLanguage :translation="$termsOfService->translations"
                                            redirect="{{ route('admin.termsOfService.index') }}" />
                                        @endif
                                    </div>
                                </div>
                                <textarea class='form-control ck-editor' id='content' placeholder='content'
                                    ...
                                    required>@if (!empty($termsOfService)){!! $termsOfService->translateOrDefault($global->adminDataLocale)->content !!}@else{!! old('content') !!}@endif</textarea>
