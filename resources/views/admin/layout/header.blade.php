...
{{-- common css --}}
<link href="{{ asset('asset') }}/admin/libs/flatpickr/dist/flatpickr.min.css?ver={{ $ver }}" rel="stylesheet" type="text/css" />
<link href="{{ asset('asset') }}/admin/libs/select2/select2.min.css" rel="stylesheet" type="text/css" />
<link href="{{ asset('asset') }}/admin/libs/sweetalert2/sweetalert2.min.css?ver={{ $ver }}" rel="stylesheet" type="text/css" />
...
<link href="{{ asset('asset') }}/admin/libs/x-editable/css/bootstrap-editable.css?ver={{ $ver }}" rel="stylesheet" type="text/css" />
