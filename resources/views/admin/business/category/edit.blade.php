...
@section('title')
@lang('common.edit') @lang('businessCategory.singular') - {{ $businessCategory->name }}
@endsection
@section('content')
...
<div class="col-sm-12 col-sm-offset-2 form-wizard">
    <div class="wizard-container">
        <div class="card wizard-card" data-color="orange" id="wizard">
            <form action="{{ route('admin.businessCategory.update' , $businessCategory) }}" method="POST">
                @csrf
                @method('PATCH')
                    ...
                    <div class="tab-pane" id="generalInformation">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                @atriatech_media_file('img', '{"name": "image", "placeholder": "{{ __("common.image") }} ({{ __("common.required") }})","file":"{{ $businessCategory->getMedium()->path ?? '' }}"}')
                                @atriatech_media_end
                            </div>
