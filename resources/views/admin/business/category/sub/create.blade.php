...
@section('title')
@lang('common.add') @lang('businessCategory.other.businessSubCategory') - {{ $businessCategory->name }}
@endsection
@section('content')
...
<div class="col-sm-12 col-sm-offset-2 form-wizard">
    <div class="wizard-container">
        <div class="card wizard-card" data-color="orange" id="wizard">
            <form action="{{ route('admin.businessCategory.storeSubCategory' , $businessCategory) }}" method="POST">
                @csrf
