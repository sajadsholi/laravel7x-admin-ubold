...
@section('title')
@lang('businessCategory.singular') - {{ $businessCategory->name }}
@endsection
@section('content')
        ...
        <div class='card-box'>
            <div class='row'>
                ...
                <div class='col-md-6 text-right'>
                    ...
                    <a href='{{ route('admin.businessCategory.createSubCategory' , $businessCategory) }}'
                        class='btn btn-orange'>
                        @lang('common.add') @lang('businessCategory.other.businessSubCategory')
                    </a>
                    @endif
                </div>
            </div>
            ...
            <div class='table-responsive'>
                <table class='table mb-0 table-responsive-xs table-striped'>
                    ...
                    <tbody>
                        @forelse($businessSubCategories as $item)
                        <tr>
                            <th>
                                {{ $loop->iteration }}
                            </th>
                ...
                {{ $businessSubCategories->onEachSide(7)->links() }}
            </div>
        </div>
    </div>
</div>
