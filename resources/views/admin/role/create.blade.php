    ...
    <div class='col-lg-12'>
        <div class='card'>
            <div class='card-body'>
                ...
                <form action="{{ route('admin.role.store') }}" method='POST' enctype='application/x-www-form-urlencoded'
                        ...
                        <div class='col-md-12'>
                            <div class='form-group mb-3'>
                                ...
                                <input type='text' class='form-control' id='name' placeholder='name' name='name'
                                    value="{{ old('name') }}"
                                    title="@lang('common.required') <br/> @lang('common.unique')" required autofocus>
