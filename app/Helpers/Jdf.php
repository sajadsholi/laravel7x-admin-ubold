...
class Jdf
{
	private static function jdate($format, $timestamp = '', $none = '', $time_zone = 'Asia/Tehran', $tr_num = 'fa')
	{
	...
	/*	F	*/
	private static function jstrftime($format, $timestamp = '', $none = '', $time_zone = 'Asia/Tehran', $tr_num = 'fa')
	{
	...
	/*	F	*/
	private static function jmktime($h = '', $m = '', $s = '', $jm = '', $jd = '', $jy = '')
	{
		$h = Jdf::tr_num($h);
		$m = Jdf::tr_num($m);
		$s = Jdf::tr_num($s);
	...
	/*	F	*/
	private static function jgetdate($timestamp = '', $none = '', $tz = 'Asia/Tehran', $tn = 'en')
	{
	...
	/*	F	*/
	private static function gregorian_to_jalali($gy, $gm, $gd, $mod = '')
	{
	...
	public static function gtoj($date, $format)
	{
	...
	public static function jtog($date, $format)
	{
		if (empty($date) || empty($format)) {
			return '';
		}
